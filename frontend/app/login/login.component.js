System.register(['angular2/core', 'angular2/router', 'angular2/common', 'angular2/http', './headers'], function(exports_1) {
    ...
    return {
        ...
        execute: function() {
            LoginFormComponent = (function () {
                ...
                LoginFormComponent.prototype.login = function (event, username, password) {
                    var _this = this;
                ...
                LoginFormComponent.prototype.signup = function (event) {
                    event.preventDefault();
